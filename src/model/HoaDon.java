...
public class HoaDon {
    ...
    private String phuon_thuc_thanh_toan;
    ...
    public HoaDon(String ma_hoa_don, TaiKhoan tai_khoan, String dia_chi_giao_hang, String phuon_thuc_thanh_toan, Timestamp ngay_mua_hang, Timestamp ngay_giao_hang, String tinh_trang_don_hang) {
        this.ma_hoa_don = ma_hoa_don;
        this.tai_khoan = tai_khoan;
        this.dia_chi_giao_hang = dia_chi_giao_hang;
        this.phuon_thuc_thanh_toan = phuon_thuc_thanh_toan;
    ...
    public String getPhuon_thuc_thanh_toan() {
        return phuon_thuc_thanh_toan;
    }

    public void setPhuon_thuc_thanh_toan(String phuon_thuc_thanh_toan) {
        this.phuon_thuc_thanh_toan = phuon_thuc_thanh_toan;
    }
