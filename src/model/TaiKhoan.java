...
public class TaiKhoan {
    ...
    public TaiKhoan(String ma_tai_khoan, String ten_tai_khoan, String ten_dang_nhap, int quyen_truy_cap, String mat_khau, String dia_chi, String so_dien_thoai, Date ngay_sinh, boolean gioi_tinh, boolean tinh_trang) {
